...
public class DischargeController {
	...
	public void dischargePatient() {
		...
		try {
			Patient patient = allAdmittedPatients.get(indexForDischarge);
			Long patientID = patient.getPatient_id();
			String uri = "http://bulhosp-pentech.rhcloud.com/rest/patient/"
					+ patientID + "/discharge";
	...
	public int getIndexForDischarge() {
		return indexForDischarge;
	}

	public void setIndexForDischarge(int indexForDischarge) {
		this.indexForDischarge = indexForDischarge;
	}
